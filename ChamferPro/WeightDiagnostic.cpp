...
static const Class_ID wrapperID(0x71293b65, 0x19374a86);
...
public:
    ...
    const TCHAR* ClassName() override { return _T("ChamferProWeightDiagnostic"); }
    const TCHAR* NonLocalizedClassName() override { return ClassName(); }
    const TCHAR* InternalName() override { return _T("ChamferProWeightDiagnostic"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags, Animatable* previous) override {
        ...
        selector = ip->AddRollupPage(instance, MAKEINTRESOURCE(201), PanelProc,
            _T("ChamferProWeightDiagnostic"), reinterpret_cast<LPARAM>(this));
    ...
    Class_ID ClassID() override { return wrapperID; }
    SClass_ID SuperClassID() override { return OSM_CLASS_ID; }
    void GetClassName(MSTR& s, bool) const override { s = _T("ChamferProWeightDiagnostic"); }
    const TCHAR* GetObjectName(bool) const override { return _T("ChamferProWeightDiagnostic"); }
