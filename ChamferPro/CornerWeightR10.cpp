...
static const Class_ID wrapperID(0x71293b6c, 0x19374a93);
...
public:
    ...
    const TCHAR* ClassName() override { return _T("ChamferProCornerWeightR10"); }
    const TCHAR* NonLocalizedClassName() override { return ClassName(); }
    const TCHAR* InternalName() override { return _T("ChamferProCornerWeightR10"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags,
        ...
        selector = ip->AddRollupPage(
            ...
            _T("ChamferProCornerWeightR10"), reinterpret_cast<LPARAM>(this));
    ...
    void GetClassName(MSTR& name, bool) const override {
        name = _T("ChamferProCornerWeightR10");
    }
    const TCHAR* GetObjectName(bool) const override {
        return _T("ChamferProCornerWeightR10");
    }
