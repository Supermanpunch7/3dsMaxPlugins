...
static const Class_ID wrapperID(0x71293b62, 0x19374a83);
...
public:
    ...
    const TCHAR* ClassName() override { return _T("ChamferProCornerWeightR2"); }
    const TCHAR* NonLocalizedClassName() override { return ClassName(); }
    const TCHAR* InternalName() override { return _T("ChamferProCornerWeightR2"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags, Animatable* previous) override {
        ...
        selector = ip->AddRollupPage(instance, MAKEINTRESOURCE(201), PanelProc,
            _T("ChamferProCornerWeightR2"), reinterpret_cast<LPARAM>(this));
    ...
    Class_ID ClassID() override { return wrapperID; }
    SClass_ID SuperClassID() override { return OSM_CLASS_ID; }
    void GetClassName(MSTR& s, bool) const override { s = _T("ChamferProCornerWeightR2"); }
    const TCHAR* GetObjectName(bool) const override { return _T("ChamferProCornerWeightR2"); }
