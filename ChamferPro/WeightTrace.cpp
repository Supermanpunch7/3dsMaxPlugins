...
static const Class_ID wrapperID(0x71293b68, 0x19374a89);
...
public:
    ...
    const TCHAR* ClassName() override { return _T("ChamferProWeightTrace"); }
    const TCHAR* NonLocalizedClassName() override { return ClassName(); }
    const TCHAR* InternalName() override { return _T("ChamferProWeightTrace"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags, Animatable* previous) override {
        ...
        selector = ip->AddRollupPage(instance, MAKEINTRESOURCE(201), PanelProc,
            _T("ChamferProWeightTrace"), reinterpret_cast<LPARAM>(this));
    ...
    Class_ID ClassID() override { return wrapperID; }
    SClass_ID SuperClassID() override { return OSM_CLASS_ID; }
    void GetClassName(MSTR& s, bool) const override { s = _T("ChamferProWeightTrace"); }
    const TCHAR* GetObjectName(bool) const override { return _T("ChamferProWeightTrace"); }
