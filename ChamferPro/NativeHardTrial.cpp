...
static const Class_ID wrapperID(0x71293b45, 0x19374a66);
...
public:
    ...
    const TCHAR* ClassName() override { return _T("ChamferProHardTrial"); }
    const TCHAR* NonLocalizedClassName() override { return ClassName(); }
    const TCHAR* InternalName() override { return _T("ChamferProHardTrial"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags, Animatable* previous) override {
        ...
        selector = ip->AddRollupPage(instance, MAKEINTRESOURCE(201), PanelProc,
            _T("ChamferProHardTrial"), reinterpret_cast<LPARAM>(this));
    ...
    Class_ID ClassID() override { return wrapperID; }
    SClass_ID SuperClassID() override { return OSM_CLASS_ID; }
    void GetClassName(MSTR& s, bool) const override { s = _T("ChamferProHardTrial"); }
    const TCHAR* GetObjectName(bool) const override { return _T("ChamferProHardTrial"); }
