...
static const Class_ID wrapperID(0x71293b71, 0x19374a98);
...
public:
    ...
    const TCHAR* ClassName() override { return _T("ChamferProEdgeChannelsR13"); }
    const TCHAR* NonLocalizedClassName() override { return ClassName(); }
    const TCHAR* InternalName() override { return _T("ChamferProEdgeChannelsR13"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags,
        ...
        selector = ip->AddRollupPage(
            ...
            _T("ChamferProEdgeChannelsR13"), reinterpret_cast<LPARAM>(this));
    ...
    void GetClassName(MSTR& name, bool) const override {
        name = _T("ChamferProEdgeChannelsR13");
    }
    const TCHAR* GetObjectName(bool) const override {
        return _T("ChamferProEdgeChannelsR13");
    }
