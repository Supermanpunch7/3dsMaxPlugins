...
static const Class_ID wrapperID(0x71293b41, 0x19374a62);
...
public:
    ...
    const TCHAR* InternalName() override { return _T("ChamferProNativeTest"); }
...
public:
    void BeginEditParams(IObjParam* ip, ULONG flags, Animatable* previous) override {
        ...
        selector = ip->AddRollupPage(instance, MAKEINTRESOURCE(201), PanelProc,
            _T("ChamferPro"), reinterpret_cast<LPARAM>(this));
    ...
    Class_ID ClassID() override { return wrapperID; }
    SClass_ID SuperClassID() override { return OSM_CLASS_ID; }
    void GetClassName(MSTR& s, bool) const override { s = _T("ChamferPro"); }
    const TCHAR* GetObjectName(bool) const override { return _T("ChamferPro"); }
